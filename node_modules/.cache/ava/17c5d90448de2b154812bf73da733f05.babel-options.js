...
const defaultOptions = envName => {
  return {
    presets: [
      "/Users/yawenina/Codes/algorithm/node_modules/babel-preset-es2015/lib/index.js"
    ],
    babelrc: false,
    env: {
      [envName]: {
        presets: [
          [
            "/Users/yawenina/Codes/algorithm/node_modules/@ava/babel-preset-transform-test-files/index.js",
            {
              powerAssert: true
            }
          ]
